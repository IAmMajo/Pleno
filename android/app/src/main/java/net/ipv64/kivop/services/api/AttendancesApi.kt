...
suspend fun getAttendances(context: Context, id: String): List<GetAttendanceDTO> = withContext(Dispatchers.IO) {
    ...
    if (response.isSuccessful) {
      ...
      if (responseBody != null) {
        ...
        return@withContext attendancesArray.map { element ->
          ...
          val identity = attendance.getAsJsonObject("identity").let { identity ->
            GetIdentityDTO(
