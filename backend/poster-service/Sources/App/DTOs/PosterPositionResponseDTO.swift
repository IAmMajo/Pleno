...
public struct PosterPositionResponseDTO: Codable {
    ...
    public init(id: UUID?, posterId: UUID? = nil, responsibleUserId: UUID? = nil, latitude: Double, longitude: Double, isDisplayed: Bool, imageUrl: String?,expiresAt:Date,postedAt:Date) {
        self.id = id
