    ...
    func prepare(on database: Database) async throws {
        ...
        let services = [
            Service(
                ...
                name: "Auth-Service",
                webhook_url: "http://localhost/auth/webhook",
            ...
            Service(
                ...
                webhook_url: "http://localhost/meeting/webhook",
            ...
            Service(
                ...
                webhook_url: "http://localhost/email/webhook",
            ...
            Service(
                ...
                name: "Poster-Service",
                webhook_url: "http://localhost/poster/webhook",
