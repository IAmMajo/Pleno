...
public struct GetEventRideDetailDTO: Codable {
    ...
    public init(id: UUID, eventID: UUID, eventName: String, driverName: String, isSelfDriver: Bool, description: String? = nil, vehicleDescription: String? = nil, starts: Date, latitude: Float, longitude: Float, emptySeats: UInt8, riders: [GetRiderDTO]) {
        self.id = id
