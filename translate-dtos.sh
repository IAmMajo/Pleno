...
declare -A basicdatatypes=( [Bool]=Boolean [Int8]=Byte [Int16]=Short [Int32]=Int [Int64]=Long [UInt8]=UByte [UInt16]=UShort [UInt32]=UInt [UInt64]=ULong [UUID]=Uuid )
### Translations
